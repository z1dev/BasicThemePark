...
//                 {
//                     verts[vertpos + ix].X += MapGlobals.TileDimension * posX;
//                     verts[vertpos + ix].Z += MapGlobals.TileDimension * posY;
//                 }
...
//                     new Float3(MapGlobals.TileDimension, 0.0f, 0.0f),
//                     new Float3(0.0f, 0.0f, MapGlobals.TileDimension),
//                     new Float3(MapGlobals.TileDimension, 0.0f, MapGlobals.TileDimension)
//                 ];
...
//         data.verts.AddRange([
//             new Float3(0.0f, 0.0f, 0.0f),
//             new Float3(r.Size.X / TileSize.X * MapGlobals.TileDimension, 0.0f, 0.0f),
//             new Float3(0.0f, 0.0f, r.Size.Y / TileSize.Y * MapGlobals.TileDimension),
//             new Float3(r.Size.X / TileSize.X * MapGlobals.TileDimension, 0.0f, r.Size.Y / TileSize.Y * MapGlobals.TileDimension)
//         ]);
...
//                     v = new Float3(baseSize.X / (float)TileSize.X, 0.0f, 0.0f) * MapGlobals.TileDimension;
//                     uv = new Float2(basePos.X + baseSize.X, basePos.Y) / new Float2(TextureSize.X, TextureSize.Y);
//                     break;
//                 case TileSide.BottomLeft:
//                     v = new Float3(0.0f, 0.0f, baseSize.Y / (float)TileSize.Y) * MapGlobals.TileDimension;
//                     uv = new Float2(basePos.X, basePos.Y + baseSize.Y) / new Float2(TextureSize.X, TextureSize.Y);
//                     break;
//                 default:
//                     v = new Float3(baseSize.X / (float)TileSize.X, 0.0f, baseSize.Y / (float)TileSize.Y) * MapGlobals.TileDimension;
...
//                     {
//                         var r = rects[t.index];
//                         v.X += r.Size.X * MapGlobals.TileDimension / (float)TileSize.X;
...
//                     {
//                         var r = rects[t.index];
//                         v.Z += r.Size.Y * MapGlobals.TileDimension / (float)TileSize.Y;
...
//         if (Mathf.Abs(bounds.Location.X + bounds.Width - MapGlobals.TileDimension) > 0.1e-6 && (side == TileSide.Right || side == TileSide.TopRight || side == TileSide.BottomRight))
//         {
//             var dif = MapGlobals.TileDimension - (bounds.Location.X + bounds.Width);
//             for (int ix = arrayIndex, siz = outVerts.Length; ix < siz; ++ix)
//                 outVerts[ix].X += dif;
//         }
...
//         if (Mathf.Abs(bounds.Location.Y + bounds.Height - MapGlobals.TileDimension) > 0.1e-6 && (side == TileSide.Bottom || side == TileSide.BottomLeft || side == TileSide.BottomRight))
//         {
//             var dif = MapGlobals.TileDimension - (bounds.Location.Y + bounds.Height);
//             for (int ix = arrayIndex, siz = outVerts.Length; ix < siz; ++ix)
//                 outVerts[ix].Z += dif;
//         }
//     }
...
//     {
//         float minX = MapGlobals.TileDimension;
//         float maxX = 0.0f;
//         float minY = MapGlobals.TileDimension;
//         float maxY = 0.0f;
...
//             var usiz = siz / MapGlobals.TileDimension * TileSize.X / TextureSize.X;
...
//             var usiz = siz / MapGlobals.TileDimension * TileSize.Y / TextureSize.Y;
